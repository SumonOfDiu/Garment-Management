...
public class GarmentManagement {
    public static void main(String[] args) {
        ...
        Garment g1 = new Garment("G0001", "Silk Shirt", "High-quality silk shirt","L","Red",1200,20);
        Garment g2 = new Garment("G0002", "Cotton T-shirt", "Comfortable cotton t-shirt","M","Blue",500,50);
        ...
        while (true) {
            ...
            System.out.println("4. Find Garment by ID Number");
